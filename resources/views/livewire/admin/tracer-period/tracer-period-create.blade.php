<div>
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl max-w-2xl">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <flux:heading size="xl">{{ __('Tambah Periode Tracer') }}</flux:heading>
                <flux:text class="text-zinc-500 dark:text-zinc-400">{{ __('Buat periode tracer study baru') }}</flux:text>
            </div>
        </div>
