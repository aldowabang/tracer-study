<div>
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl max-w-2xl">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <flux:heading size="xl">{{ __('Edit Pertanyaan Tracer') }}</flux:heading>
                <flux:text class="text-zinc-500 dark:text-zinc-400">{{ __('Perbarui pertanyaan tracer study') }}</flux:text>
            </div>
        </div>
        ...
        <form wire:submit="save" class="space-y-6">
            <div class="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <flux:input wire:model="urutan" :label="__('Urutan')" type="number" min="0" required size="lg" />
                </div>
